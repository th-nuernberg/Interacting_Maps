 ...
 * @return
 */
bool isApprox(const xt::xarray<float> &t1, const xt::xarray<float> &t2, float precision);
 ...
 * @param C Output Tensor of shape NxMxD
 */
void crossProduct3x3(const xt::xtensor<float, 3> &A, const xt::xtensor<float, 3> &B, xt::xtensor<float, 3> &C);
 ...
 * @param C Resulting collection of cross product vectors as a 3-Tensor
 */
void crossProduct1x3(const xt::xtensor<float, 1> &A, const xt::xtensor<float, 3> &B, xt::xtensor<float, 3> &C);
 ...
 * @param Cx x-Derivative (width) of camera calibration matrix
 * @param Cy y-Derivative (height) of camera calibration matrix
 ...
 * @param Out Resulting 3-Vector
 */
void m23(const xt::xtensor<float, 3>& In, const xt::xtensor<float, 3> &Cx, const xt::xtensor<float, 3> &Cy, xt::xtensor<float, 3> &Out);
 ...
 * @return
 */
float VFG_check(const xt::xtensor<float, 2> &V, const xt::xtensor<float, 3> &F, const xt::xtensor<float, 3> &G);
 ...
 * @param points
 */
void setup_R_update(const xt::xtensor<float, 3> &CCM, xt::xtensor<float, 2> &A, xt::xtensor<float, 1> &B, xt::xtensor<float, 4> &Identity_minus_outerProducts, xt::xtensor<float, 3> &points);
 ...
 * @param gamma G values with magnitude larger get rounded to gamma (or -gamma)
 */
void update_GI(xt::xtensor<float, 3> &G, const xt::xtensor<float, 3> &I_gradient, float weight_GI, float eps=1e-8, float gamma=255.0);
 ...
 * @param x horizontal coordinate of the updated pixel
 */
void updateGIDiffGradient(xt::xtensor<float, 3> &G, xt::xtensor<float, 3> &I_gradient, xt::xtensor<float, 3> &GIDiff, xt::xtensor<float, 3> &GIDiffGradient);
 ...
 * @param weight_IG weight for convex combination with old I value, 0 = no update
 */
void update_IG(xt::xtensor<float, 2> &I, const xt::xtensor<float, 3> &GIDiffGradient, float weight_IG=0.5);
 ...
 * @param weight_IV weight for convex combination with old I value, 0 = no update
 */
void contribute(xt::xtensor<float, 2> &I, float V, int y, int x, float minPotential, float maxPotential, const float weight_IV);
 ...
 * @param dP decay parameter
 */
void globalDecay(xt::xtensor<float, 2> &I, xt::xtensor<float, 2> &decayTimeSurface, xt::xtensor<float, 2> &nP, xt::xtensor<float, 2> &t, xt::xtensor<float, 2> &dP);
 ...
 * @param decayParam decay parameter
 */
void linearDecay(xt::xtensor<float, 2> &I, xt::xtensor<float, 2> &decayTimeSurface, float time, float neutralPotential, float decayParam);
 ...
 * @param decayParam decay parameter
 */
void exponentialDecay(xt::xtensor<float, 2> &I, xt::xtensor<float, 2> &decayTimeSurface, const float time, const float neutralPotential, const float decayParam);
 ...
 * @param weight_IV weighting of the update, 0 = no update, 1.0 = overwrite old value fully.
 */
void update_IV(xt::xtensor<float, 2> &I, xt::xtensor<float, 2> &V,float minPotential, float maxPotential, float weight_IV);
 ...
 * @param weight_Ifusion weighting of the update, 0 = no update, 1.0 = overwrite old value fully.
 */
void update_Ifusion(xt::xtensor<float, 2> &I, const cv::Mat &realImage, const float weight_Ifusion);
 ...
 * @param gamma
 */
void update_FR(Tensor3f &F, const Tensor3f &CCM, const Tensor3f &Cx, const Tensor3f &Cy, const Tensor1f &R, float weight_FR, float eps, float gamma);
 ...
 * @param x
 */
void update_RF(xt::xtensor<float, 1> &R, const xt::xtensor<float, 3> &F, const xt::xtensor<float, 3> &C, const xt::xtensor<float, 3> &Cx, const xt::xtensor<float, 3> &Cy, const xt::xtensor<float, 2> &A, xt::xtensor<float, 1> &B, const xt::xtensor<float, 4> &Identity_minus_outerProducts, xt::xtensor<float, 3> &old_points, float weight_R);
 ...
 * @param weight_RIMU weighting between both values; 1.0 = 100% rotVelIMU, 0.0 = 100% R
 */
void update_RIMU(xt::xtensor<float, 1> &R, const xt::xtensor<float, 1> &rotVelIMU, float weight_RIMU);
 ...
 * @param weight_Ifusion how the images should be weighted relative to each other, 1 = 100% new image.
 */
void update_Ifusion(xt::xtensor<float, 2> &I, const cv::Mat &realImage, float weight_Ifusion);
#endif //UPDATE_H
